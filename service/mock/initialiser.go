...
func (mock *InitialiserMock) DoGetHTTPServer(bindAddr string, router http.Handler, cfg *config.Config) service.HTTPServer {
	...
	return mock.DoGetHTTPServerFunc(bindAddr, router, cfg)
}
